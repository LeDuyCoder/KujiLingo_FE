...
export const Button = ({
  ...
  const baseClasses = "flex h-12 w-full items-center justify-center rounded-full px-5 transition-all active:scale-[0.98] active:opacity-95 font-medium cursor-pointer";
  const variants = {
